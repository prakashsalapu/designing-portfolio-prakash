...
const Services = () => {
  return (
    <section id="services" className="px-4 py-24 text-white sm:px-8 lg:px-16 scroll-mt-28">
          ...
          {services.map((service, idx) => {
            ...
            return (
              <motion.div
                key={idx}
                className={clsx(
                  "relative text-center rounded-2xl p-6 w-full max-w-xs transition-all duration-300 transform bg-slate-900/55 border border-white/10 text-slate-100 shadow-md backdrop-blur-md",
                  "hover:-translate-y-3 hover:shadow-[0_0_34px_rgba(56,189,248,0.24)] hover:ring-1 hover:ring-sky-300/60 group"
                )}
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <h3 className="text-lg font-bold mb-3 leading-tight transition-colors duration-300 group-hover:text-cyan-300">
                    {service.title}
                  </h3>
